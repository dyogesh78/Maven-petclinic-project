node {
 ...
 stage ('SCM_Checkout') {
    checkout([$class: 'GitSCM', 
        ...
        userRemoteConfigs: [[url: 'https://github.com/dyogesh78/Maven-petclinic-project.git']]])
 }
 ...
 stage ('Archive and Notify') {
    ...
    step([$class: 'Mailer', 
        ...
        recipients: 'cc:dyogesh78@yahoo.com', 
 ...
 def notify(status) {
  mail (
        ...
        cc: 'dyogesh78@yahoo.com', 
        subject: """JenkinsNotification: ${status}:""", 
        to: 'dyogesh78@yahoo.com'  
       ) 
 }